...
extension SonarrHistoryEventTypeExtension on SonarrHistoryEventType {
  ...
  SonarrHistoryEventType? from(String? type) {
    switch (type) {
      case 'episodeFileRenamed':
        return SonarrHistoryEventType.EPISODE_FILE_RENAMED;
      case 'episodeFileDeleted':
        return SonarrHistoryEventType.EPISODE_FILE_DELETED;
      case 'downloadFolderImported':
        return SonarrHistoryEventType.DOWNLOAD_FOLDER_IMPORTED;
      case 'downloadFailed':
        return SonarrHistoryEventType.DOWNLOAD_FAILED;
      case 'grabbed':
        return SonarrHistoryEventType.GRABBED;
      default:
        return null;
    }
  }
  ...
  String? get value {
    switch (this) {
      case SonarrHistoryEventType.EPISODE_FILE_RENAMED:
        return 'episodeFileRenamed';
      case SonarrHistoryEventType.EPISODE_FILE_DELETED:
        return 'episodeFileDeleted';
      case SonarrHistoryEventType.DOWNLOAD_FOLDER_IMPORTED:
        return 'downloadFolderImported';
      case SonarrHistoryEventType.DOWNLOAD_FAILED:
        return 'downloadFailed';
      case SonarrHistoryEventType.GRABBED:
        return 'grabbed';
    }
  }
}
