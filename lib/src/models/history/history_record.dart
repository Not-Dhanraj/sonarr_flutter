...
import 'package:sonarr_flutter/models.dart';
import 'package:sonarr_flutter/types.dart';
import 'package:sonarr_flutter/utilities.dart';
...
class SonarrHistoryRecord {
  ...
  @JsonKey(
    name: 'eventType',
    toJson: SonarrUtilities.historyEventTypeToJson,
    fromJson: SonarrUtilities.historyEventTypeFromJson,
  )
