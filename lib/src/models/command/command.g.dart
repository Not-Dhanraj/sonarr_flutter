...
SonarrCommand _$SonarrCommandFromJson(Map<String, dynamic> json) =>
    SonarrCommand(
        ...
        startedOn: SonarrUtilities.dateTimeFromJson(
          json['startedOn'] as String?,
        ),
      ...
      ..stateChangeTime = SonarrUtilities.dateTimeFromJson(
        json['stateChangeTime'] as String?,
      );

Map<String, dynamic> _$SonarrCommandToJson(
  SonarrCommand instance,
) => <String, dynamic>{
  'name': instance.name,
  ...
  'stateChangeTime': SonarrUtilities.dateTimeToJson(instance.stateChangeTime),
